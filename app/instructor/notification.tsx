...
import { Bell, MessageCircle, BookOpen, Award, Users, Calendar } from 'lucide-react-native';
import { router } from 'expo-router';

type NotificationType = 'message' | 'course' | 'achievement' | 'enrollment' | 'reminder';
      ...
      <View style={styles.header}>
        ...
        {notifications.length > 0 && (
          <TouchableOpacity
            ...
            onPress={() => setNotifications(prevNotifications =>
