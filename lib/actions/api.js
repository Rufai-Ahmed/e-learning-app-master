      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [
              4 /*yield*/,
              axios_1.axios.post("/auth/register", body, {
                headers: {
                  Authorization: "",
                },
                params: {
  ...
  signinAccount: function (data) {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [4 /*yield*/, axios_1.axios.post("/auth/login", data)];
          case 1:
            response = _a.sent();
            return [2 /*return*/, response.data];
        }
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [
              4 /*yield*/,
              axios_1.axios.post("/auth/resend-verification-email", data),
            ];
          case 1:
            response = _a.sent();
            return [2 /*return*/, response.data];
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [
              4 /*yield*/,
              axios_1.axios.post("/auth/forgot-password", data),
            ];
          case 1:
            response = _a.sent();
            return [2 /*return*/, response.data];
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [
              4 /*yield*/,
              axios_1.axios.post("/auth/verify-email", data),
            ];
          case 1:
            response = _a.sent();
            return [2 /*return*/, response.data];
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [
              4 /*yield*/,
              axios_1.axios.post("/auth/reset-password", data),
            ];
          case 1:
            response = _a.sent();
            return [2 /*return*/, response.data];
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [
              4 /*yield*/,
              axios_1.axios.get("/auth/logout/".concat(id), {
                headers: {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [
              4 /*yield*/,
              axios_1.axios.post("/users/category", data, {
                headers: {
                  Authorization: "Bearer ".concat(token),
                },
              }),
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [
              4 /*yield*/,
              axios_1.axios.post("/auth/update-password", data, {
                headers: {
                  Authorization: "Bearer ".concat(token),
                },
              }),
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              axios_1.axios.delete("/users/".concat(id), {
                headers: {
                  Authorization: "Bearer ".concat(token),
                },
                params: {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              axios_1.axios.get("/courses/".concat(id), {
                headers: {
                  Authorization: "Bearer ".concat(token),
                },
              }),
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              axios_1.axios.put("/courses/".concat(id), {
                headers: {
                  Authorization: "Bearer ".concat(token),
                },
              }),
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              axios_1.axios.delete("/courses/".concat(id), {
                headers: {
                  Authorization: "Bearer ".concat(token),
                },
              }),
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              axios_1.axios.get("/users/".concat(id, "/category"), {
                headers: {
                  Authorization: "Bearer ".concat(token),
                },
              }),
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [
              4 /*yield*/,
              axios_1.axios.get("/users/".concat(id, "/courses"), {
                headers: {
                  Authorization: "Bearer ".concat(token),
                },
              }),
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              axios_1.axios.post("/courses/".concat(id, "/rate"), {
                headers: {
                  Authorization: "Bearer ".concat(token),
                },
              }),
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              axios_1.axios.get("/courses/".concat(id, "/rate"), {
                headers: {
                  Authorization: "Bearer ".concat(token),
                },
              }),
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              axios_1.axios.post("/courses/".concat(id, "/enroll"), {
                headers: {
                  Authorization: "Bearer ".concat(token),
                },
              }),
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              axios_1.axios.post("/courses", body, {
                headers: {
                  Authorization: "Bearer ".concat(token),
                },
              }),
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              axios_1.axios.post("/courses/".concat(id, "/modules"), body, {
                headers: {
                  Authorization: "Bearer ".concat(token),
                },
              }),
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              axios_1.axios.get("/courses/".concat(id, "/modules"), {
                headers: {
                  Authorization: "Bearer ".concat(token),
                },
              }),
        ...
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              axios_1.axios.get(
                "/courses/".concat(id, "/modules/").concat(userId),
                {
                  headers: {
                    Authorization: "Bearer ".concat(token),
                  },
        ...
        switch (_a.label) {
          case 0:
            ...
            return [
              ...
              axios_1.axios.post(
                "/courses/"
                  .concat(courseId, "/modules/")
                  .concat(moduleId, "/lessons/")
                  .concat(lessonId, "/upload-video"),
                body,
                {
                  headers: {
                    Authorization: "Bearer ".concat(token),
          ...
          case 2:
            ...
            console.error(
              ...
              err_1.response.data.detail[0].loc
            );
        ...
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              axios_1.axios.post(
                "/courses/".concat(id, "/image-upload"),
                body,
                {
                  headers: {
                    Authorization: "Bearer ".concat(token),
          ...
          case 2:
            ...
            console.error(
              "Error publishing course:",
              err_2.response.data.detail[0].loc
            );
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [
              4 /*yield*/,
              axios_1.axios.get("/instructors/".concat(id, "/courses"), {
                headers: {
                  Authorization: "Bearer ".concat(token),
                },
              }),
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [
              4 /*yield*/,
              axios_1.axios.put("/courses/".concat(id), body, {
                headers: {
                  Authorization: "Bearer ".concat(token),
                },
              }),
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [
              4 /*yield*/,
              axios_1.axios.get("/courses/".concat(name), {
                headers: {
                  Authorization: "Bearer ".concat(token),
                },
              }),
