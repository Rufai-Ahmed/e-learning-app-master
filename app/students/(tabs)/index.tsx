...
import { View, ScrollView, Text, StyleSheet, FlatList, TouchableOpacity, ActivityIndicator } from 'react-native';
import { SafeAreaView } from 'react-native-safe-area-context';
import { recommendedCourses, popularCourses } from '@/mock-data/mock-data';
...
const HomeScreen = () => {
  ...
  const fetchCourses = async () => {
    ...
    try {
      ...
      console.log("Error fetching courses:", error.response.data);
