...
export default function SupportScreen() {
  ...
  const handleOpenGuides = () => {
    // Navigate to instructor guides
    router.push('/instructor/guides');
  };
  ...
  const supportSections: SupportSection[] = [
    ...
    },
    {
      ...
      items: [
        ...
        //   description: 'Learn how to create better courses',
        ...
        // },
        {
          ...
          action: () => router.push('/instructor/profile/faqs'),
        },
      ],
    },
    {
      ...
      items: [
        {
          ...
          action: () => router.push('/instructor/profile/terms'),
        },
        {
          id: 'report',
          ...
          action: () => router.push('/instructor/profile/report-issue'),
        },
      ],
    },
  ];
