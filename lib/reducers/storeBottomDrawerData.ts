...
getSelectedInternationalAirtimeCountry: (state, action: PayloadAction<any>) => {
  state.selectedInternationalAirtimeCountry = action.payload
},
getSelectedInternationalAirtimeProductType: (state, action: PayloadAction<any>) => {
...
getSelectedFlightDepartureLocationData: (state, action: PayloadAction<any>) => {
...
getSelectedFlightDestinationLocationData: (state, action: PayloadAction<any>) => {
...
getSelectedInternationalAirtimeOperator: (state, action: PayloadAction<any>) => {
  state.selectedInternationalAirtimeOperator = action.payload
},

getSelectedInternationalAirtimeOperatorPlans: (state, action: PayloadAction<any>) => {
  state.selectedInternationalAirtimeOperatorPlans = action.payload
},
getInternationalAirtimeOperatorPlans: (state, action: PayloadAction<any>) => {
  ...
  getSelectedThirdPartInsurancePartyCode: (state, action: PayloadAction<any>) => {
  ...
  getThirdPartyInsuranceEngineCapacity: (state, action: PayloadAction<any>) => {
    state.thirdPartyInsuranceEngineCapacity = action.payload
  },
  getSelectedThirdPartyInsuranceEngineCapacity: (state, action: PayloadAction<any>) => {
    state.selectedThirdPartyInsuranceEngineCapacity = action.payload
  },
  getThirdPartyInsuranceLocalGovAreaCode: (state, action: PayloadAction<any>) => {
    state.thirdPartyInsuranceLocalGovAreaCode = action.payload
  },
  getSelectedThirdPartyInsuranceLocalAreaCode: (state, action: PayloadAction<any>) => {
...
export const { getCountriesData, getInternationalAirtimeCountries,getEsimsData,
getBettingData, getHomeInsuranceForm, getPersonalAccoutInusurance,
getThirdPartInsurance,
getSelectedFlightBookingData,
getFlightBookingOffersData,
getElectricityData,getSelectedTvData,getInternetDrawerItem, getTvData,
getDataBundleData, getSelectedInternationalAirtimeCountry,
getServiceNetworkData,
getSelectedCountriesData,getSelectedInternationalAirtimeProductType,
getFlightDepartureLocationData, getFlightDestinationLocationData,
getSelectedFlightDepartureLocationData, getSelectedFlightDestinationLocationData,
getJambPaymentOptionData, getEducationPaymentOption,
getInternationalAirtimeProductType,
getSelectedInternationalAirtimeOperator,getSelectedInternationalAirtimeOperatorPlans,
getInternationalAirtimeOperatorPlans, getInternationalAirtimeOperator,
getThirdPartyInsurancePartyCode, 
  getSelectedThirdPartInsurancePartyCode, getSelectedThirdPartyInsuranceEngineCapacity, getSelectedThirdPartyInsuranceLocalAreaCode, getSelectedThirdPartyMakeCode, getSelectedThirdPartyStateCode, getSelectedThirdPartyVehicleModel,getThirdPartyInsuranceEngineCapacity, getThirdPartyInsuranceLocalGovAreaCode, getThirdPartyVehicleModel, getThirdPartyStateCode, getThirdPartyMakeCode, getSelectedEsimsData, getSelectedThirdPartyInsurance } = storeBottomDrawerSlice.actions
